...
const PAROLE_SINGOLE = [
  ...
  // ANIMALI (aggiunte)
  "Allocco","Anemone","Axolotl","Barracuda","Beccaccino","Bertuccia",
  ...
  "Krill","Luccioperca","Manta","Moffetta","Muggine","Ostriche",
  "Passero","Pescecane","Quokka","Salamandrina",
  "Scarafaggio","Taccola","Tacchino","Toporagno","Tortora",
  "Verdone","Vipera","Volpoca","Wapiti","Xerus",
  ...
  "Rabdomante","Ragioniere","Ricettatore","Rigattiere","Sagrestano","Scaricatore",
  ...
  "Cascina","Cenote","Colle","Conca","Contrafforte",
  "Depressione","Dorsale","Erg","Falesia","Forra","Giara",
  "Gole","Golena","Greppo","Laguna","Lanca",
  "Landa","Litorale","Massiccio","Mogote","Mulattiera",
  ...
  "Acapella","Accordo","Atonale","Barocco","Belcanto","Bemolle",
  "Bozzetto","Cadenza","Caricatura","Collage","Contrappunto","Couplet",
  "Dissonanza","Duetto","Falsetto","Figurativismo","Gouache","Graffito",
  "Impasto","Improvvisazione","Intarsio","Intermezzo","Leitmotiv","Minimalismo",
  "Monotono","Monocromo","Murale","Naturalismo","Ouverture",
  "Paesaggista","Pentagramma","Pittoresco","Puntinismo","Quartetto","Quintetto",
  "Recital","Repertorio","Restauro","Ritornello","Rondò","Rubato",
  "Sincopato","Staccato","Stilista","Surrealismo",
  "Tocco","Tonalità","Trascrizione","Tratteggio","Trio",
  "Vernissage","Virtuosismo","Vocalizzo",
  // SCIENZA E TECNOLOGIA (aggiunte)
  "Acceleratore","Aereodinamica","Amplificatore","Antimateria","Applicazione","Architettura",
  "Biologia","Biometria","Calibrazione","Catalizzatore","Centrifuga","Cifratura",
  "Climatologia","Clonazione","Compilatore","Compressione","Conduzione","Convezione",
  "Crittografia","Decodifica","Elettrolisi","Emissione","Entropia","Equazione",
  "Esperimento","Estrazione","Filamento","Formula","Fotovoltaico","Generatore",
  "Geotermico","Idraulica","Inerzia","Innovazione","Isoterma","Logaritmo",
  "Magnetometro","Modulazione","Nanometro","Neutro","Nucleare",
  "Optoelettronica","Oscillazione","Ossidazione","Parametro","Particella","Pendenza",
  "Reazione","Riciclaggio","Rifrazione","Robotica","Sensore",
  "Spettroscopio","Supercollisore","Telemetria","Termodinamica","Trasduttore",
  "Velocimetro","Voltaggio","Wavelength",
  ...
  "Abbaino","Alcova","Anticamera","Apiario","Belvedere","Boiserie",
  "Botola","Bugnato","Cancello","Colonnato","Controsoffitto","Corrimano",
  "Doccione","Dormitorio","Erker","Facciata","Frangisole","Fumaiolo",
  ...
  "Tramezzo","Traversina","Trilite","Velario",
  // TRASPORTI (aggiunte)
  ...
  "Limousina","Maglev","Monovolume","Motovedetta","Navetta","Panfilo",
  ...
  "Biografia","Calligramma","Cantico","Carme","Cesura","Climax",
  "Commedia","Compendio","Dedica","Diario","Dizione",
  "Dramma","Emistichio","Endecasillabo","Enjambement","Eufemismo","Farsa",
  "Giambo","Glosse","Incunabolo","Intertestualità","Litote","Lirismo",
  "Manoscritto","Memorie","Metonimia","Miscellanea","Ottava","Pamphlet",
  "Parabola","Parodia","Pastiche","Perifrasi","Poema","Postfazione",
  "Prefazione","Pseudonimo","Quartina","Retorica","Saggiare","Satira",
  "Sillaba","Sinossi","Spondeo","Terzina","Tragedia","Trattato",
  "Tropo","Vademecum","Vignetta",
  // DIRITTO (aggiunte)
  "Abrogazione","Adesione","Arbitrato","Citazione","Clausola",
  "Codicillo","Colpa","Conciliazione","Concessione","Contravvenzione","Controversia",
  ...
  "Requisitoria","Rito","Rogito","Sanzione","Sopralluogo","Sospensione",
  ...
  "Ciclogenesi","Condensa","Corrente a getto","Fronte caldo","Fronte freddo",
  "Galaverna","Gelo","Graupel","Inversione termica","Isobarica",
  ...
  "Umidità","Ventata","Verglas","Vortice polare",
  ...
  // MONDO MARINO
  "Abisso","Bassofondo","Batiscafo","Bozzello",
  "Braccio di mare","Briccola","Cabotaggio",
  "Frangente","Gomena","Mareggiata","Ormeggio","Pontile",
  "Prua","Rada","Rollio","Scoglio","Secca",
  "Sentina","Scia","Traverso",
  // TESSUTI E MATERIALI (aggiunte)
  "Alcantara","Bouclé","Broccatello","Cambric","Canvas","Charmeuse",
  "Cimosa","Cretonne","Damasco","Duchesse","Feltro",
  "Flanella","Fustagnola","Gabardine","Georgette","Jersey","Juta",
  "Lamé","Lycra","Madras","Maglina","Microfibra","Moleskin",
  "Mussolina","Neoprene","Nylon","Percalle","Pile","Popeline",
  "Rayon","Reps","Shantung","Spandex",
  "Viscosa","Voile",
  // MESTIERI ANTICHI E RARI
  "Alabardiere","Alchimista","Ammaestratore","Araldo","Armaiolo","Banditore",
  "Barcaiolo","Bottaio","Calderaio","Candeliere","Cantastorie","Carbonaio",
  "Carrettiere","Cestaio","Ciociaro","Cordaio","Cerusico","Ciarlatano",
  "Fuochista","Gualchieraio","Lanaiolo","Lattaio","Materassaio","Merciaio",
  "Ombrellaio","Orologiaio","Ottonaio","Pentoliere","Ramaiolo","Sellaio",
